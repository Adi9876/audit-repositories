...
contract ThunderLoanTest is BaseTest {
    ...
    function testOracleManipulation() public {
       thunderLoan = new ThunderLoan();
        ...
        // Take out a flash loan of 50 token
        // swap it on the dex, tanking te price > 150 TokenA →> ~80 WETH
        // Take out ANOTHER flash loan of 50 tokenA (and we'll see how much cheaper it is!!)



        //  we are goind to take out two flash loans
        //        -> to nuke the price of Weth/tokenA on tswap
        //        -> to show that doing show reduces the fees to pay on ThunderLoan
        ...
        console2.log("Normal fee: %s", calculatedFeeNormal);
        console2.log("Attack fee: %s", calculatedFeeAttack);
    ...
    function testUpgradeBreaks() public {
        ...
        vm.stopPrank();
        assert(feeBeforeUpgrade != feeAfterUpgrade); //all because of storage miss match in new contract
    }
}
